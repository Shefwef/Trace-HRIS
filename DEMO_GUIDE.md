...
2. **Cast of characters** - the 4 roles and 12 real users
...
> **For the demo:** you don't need to open 12 browsers - just pick the roles you're
...
1. Open the login page. Point out: only the 12 pre-approved emails can sign in. If you type any other email, Clerk (the auth layer) refuses. This is the security allowlist.
...
**Now switch to: Saifullah (HR)** - this is why we lined up multiple windows.
