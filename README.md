...
a team of 6 today, scales cleanly to 100+ without architectural changes.
...
| Role | Name | Email | Employee ID | Photo in `public/` |
|---|---|---|---|---|
...
Initial passwords follow the pattern `Trace-HRIS-<FirstName>-2026!` and are documented in [`hris/SETUP.md`](./hris/SETUP.md). Every user should change their password on first sign-in via avatar → **Account settings**.
